...
(function () {
  var NumberOfQuestion = 100; // total number of question for the whole exam
  ...
  function displayNext() {
    quiz.fadeOut(function () {
      ...
      if (questionCounter < questions.length) {
        ...
        var progress = (questionCounter / NumberOfQuestion) * 100; // Assuming there are 100 questions
  ...
  function generateResultsPage() {
    ...
    let html = `
              ...
              <head>
                  ...
                  <title>APTIS 3 Exam Results</title>
